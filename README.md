...
Учебный frontend-проект на **React 17 и TypeScript**. Здесь я разбираюсь в структуре приложения: разделении кода на слои, маршрутизации, темах оформления и локализации.
...
Это один из моих pet-проектов: я использую его для изучения frontend-архитектуры и практики с инструментами разработки.
